...
public class Dizionario_7_cifre{
    public static void main(String[] args) throws IOException {
        ...
        FileWriter fw = new FileWriter("O:\\xxx\\javaDizionario-a-7-cifre.txt", true);
        String str = "";
                        ...
                        for(int a5 = 0; a5<total.length;a5++){
                            for(int a6 = 0; a6<total.length;a6++){
                                for(int a7 = 0; a7<total.length;a7++){
                                        str += total[a1]+""+total[a2]+""+total[a3]+""+total[a4]+""+total[a5]+""+total[a6]+""+total[a7];
                                        fw.write(str+"\n");
                                        str="";
                                }
                            }
