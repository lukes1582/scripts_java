...
public class Dizionario_6_cifre{
    public static void main(String[] args) throws IOException {
        ...
        FileWriter fw = new FileWriter("O:\\xxx\\javaDizionario-a-6-cifre.txt", true);
        String str = "";
                    ...
                    for(int a4 = 0; a4<total.length;a4++){
                        for(int a5 = 0; a5<total.length;a5++){
                            for(int a6 = 0; a6<total.length;a6++){
                                str += total[a1]+""+total[a2]+""+total[a3]+""+total[a4]+""+total[a5]+""+total[a6];
                                fw.write(str+"\n");
                                str="";
                            }
                        }
