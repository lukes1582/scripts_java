...
public class importaDizionario_15_4pin_galattico {
	...
	public static void main(String[] args) {
		...
		try {
			...
			FileReader xFile = new FileReader("O:\\xxx\\dizionario-4pin.txt");
			...
			while ((s = bf.readLine()) != null) {
				...
				String sql = "INSERT INTO `dizionari`.`diz_15_pin_hashs` (`id`, `dic_value`, `hash_md5`, `hash_sha1`, `hash_sha256`, `hash_sha384`, `hash_sha512`) VALUES (NULL,'"
						+ s
						+ "','"
						+ md5
						+ "','"
