...
public class CalcolcaDistanzaTra2Punti extends JFrame {
	...
	public CalcolcaDistanzaTra2Punti(){
		this.setBounds(100, 100, 350, 500);
		this.setTitle("--- Calcola Distanza Tra Due Punti ---");
		...
		//----------------------------------------------------------------
		JLabel l3 = new JLabel("Distance is: ");
		jpan3.add(l3);
